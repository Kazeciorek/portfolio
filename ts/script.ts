//variables
const SHOW_MENU = document.querySelector<HTMLElement>("#show-menu");
const SHOW_MENU__CONTAINER = document.querySelector<HTMLElement>("nav > div");

const JAVASCIRPT_BUTTON = document.querySelector<HTMLElement>(".javascript");
...
JAVASCIRPT_BUTTON.addEventListener("click", () => {
    ...
    EXPLOSION2.appendChild<Node>(EXPLOSION3);

    const EXPLOSION1 = document.createElement("div");
    EXPLOSION1.classList.add("explode1");
    EXPLOSION1.appendChild<Node>(EXPLOSION2);
    ...
    */
    ...
    document
        ...
        .appendChild<Node>(ROCKET__ANIMATION);
    let position = 0;
    let id = null;
    const animate = () => {
        if (position >= randomwidth) {
            ...
            document
                .querySelector<HTMLElement>("#main")
                .removeChild<Node>(ROCKET__ANIMATION);
            document
                .querySelector<HTMLElement>("#main")
                .appendChild<Node>(EXPLOSION1);
